...
x86_64-w64-mingw32-g++.exe -O2 -s -Wall -Wextra -Wpedantic -std=c++17 -o Infinite main.cpp create.cpp MakeBMP.cpp MetaZone.cpp QuatroStack.cpp solve.cpp Zone.cpp city_w.o -luser32 -lgdi32 -lgdiplus -lopengl32 -lSHlwapi -ldwmapi -lstdc++fs -lwinmm -Wl,-subsystem,windows
